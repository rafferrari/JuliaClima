...
md"""
## Application to present climate
---
...
# ╔═╡ 3f68cd4d-8bba-4e71-93ff-3afa95d0d07f
...
# ╔═╡ 2e08dda0-4bcf-41f0-82b0-ef9736184dbd
begin
...
Climate feedback λₛ = $(@bind λₛ Slider(0:.1:4, show_value=true, default=2.42))

Upper ocean Heat Capacity C =$(@bind C Slider(0.1:.1:200, show_value=true, default=8.9))
